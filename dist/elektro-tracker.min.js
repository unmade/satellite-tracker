...
"use strict";$(document).ready(function(){function e(){u.update(),requestAnimationFrame(e);var n=s.position.length();return t.sky.material.uniforms.fCameraHeight.value=n,t.sky.material.uniforms.fCameraHeight2.value=n*n,t.ground.material.uniforms.fCameraHeight.value=n,t.ground.material.uniforms.fCameraHeight2.value=n*n,l.render(d,s)}function n(){s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),l.setSize(window.innerWidth,window.innerHeight)}var i=document.getElementById("scene"),a=window.innerWidth,r=window.innerHeight,t=TRACKER.earth,o=TRACKER.sun,d=new THREE.Scene;d.add(t.ground.mesh),d.add(t.sky.mesh),d.add(o.lensFlare);var s=new THREE.PerspectiveCamera(70,a/r,1,15e3);s.position.set(5600,5300,500),s.up=new THREE.Vector3(0,0,1);var l=new THREE.WebGLRenderer({antialias:!0,alpha:!0});l.setPixelRatio(window.devicePixelRatio||1),l.setSize(a,r),l.setClearColor(0,1),i.appendChild(l.domElement);var u=new THREE.TrackballControls(s);e();window.addEventListener("resize",n,!1)});
