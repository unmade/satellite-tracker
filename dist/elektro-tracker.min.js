...
TRACKER.namespace("utils.Loaders"),TRACKER.utils.Loaders=function(){"use strict";function e(e,r,o){var n=$.Deferred(),a=new THREE.OBJLoader;return a.load(o,function(o){e[r]=o,n.resolve()}),n}function r(e,r,o,n){var a=$.Deferred(),d=new THREE.MTLLoader;return d.load(n,function(n){n.preload();var d=new THREE.OBJLoader;d.setMaterials(n),d.load(o,function(o){e[r]=o,a.resolve()})}),a.promise()}function o(e,r,o){var n=$.Deferred(),a=new THREE.TextureLoader;return a.crossOrigin="anonymous",a.load(o,function(o){e[r]=o,n.resolve()}),n}return{defferedOBJLoader:e,defferedOBJMTLLoader:r,defferedTextureLoader:o}}();
