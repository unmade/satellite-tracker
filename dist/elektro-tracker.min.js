...
TRACKER.namespace("Player"),TRACKER.Player=function(){"use strict";function e(e){var t=e||{};return k.date=t.date||new Date,k.width=$(document).width(),k.onDateChangeCallback=t.onDateChangeCallback||null,k.onSystemCoordinateChangeCallback=t.onSystemCoordinateChangeCallback||null,k.updateScale(k.range,k.width),k.updateDateRange(k.date),k.updateHover(),$("#play").click(k.togglePlay),$("#rewind").click(k.rewind),$("#forward").click(k.forward),$("#now").click(k.toNow),$("#speed").click(k.toggleSpeed),$("#coordinate_system").click(k.toggleCoordinateSystem),$(".st-progress-bar").mousedown(k.onDateClicked).mousemove(k.onDateChange).mouseenter(k.showPrehover).mouseleave(k.hidePrehover),$(document).mousemove(k.onDateClickedAndMove).mouseup(k.dateClicked),k}function t(e){k.clicked=!1}function a(){k.date.setUTCMonth(k.date.getUTCMonth()+1),k.updateDateRange(k.date),k.play||"function"!=typeof k.callback||k.callback()}function n(){k.clicked||($(".st-hover-progress").hide(100),$(".st-selected-date").hide(100))}function o(e){var t=new Date(k.startDate+k.scale*e.pageX);$(".st-selected-date").css({left:k.width/2>=e.pageX?e.pageX:"auto",right:k.width/2<e.pageX?k.width-e.pageX:"auto"}).text(t),$(".st-hover-progress").css({width:e.pageX}),k.clicked&&($(".st-play-progress").css({width:e.pageX}),k.date=t,k.play||"function"!=typeof k.callback||k.callback())}function l(e){k.clicked=!0,k.onDateChange(e)}function c(e){k.clicked&&k.onDateChange(e)}function d(){k.date.setUTCMonth(k.date.getUTCMonth()-1),k.updateDateRange(k.date),k.play||"function"!=typeof k.callback||k.callback()}function i(){$(".st-hover-progress").show(100),$(".st-selected-date").show(100)}function s(){k.play=!k.play,$("#pause_button").toggleClass("hide"),$("#play_button").toggleClass("hide")}function r(){$(this).toggleClass("warning"),k.coordinateSystem="heliocentric"===k.coordinateSystem?"geocentric":"heliocentric","function"==typeof k.onSystemCoordinateChangeCallback&&k.onSystemCoordinateChangeCallback()}function g(){$(this).toggleClass("red"),k.speed=1e3===k.speed?3e3:1e3}function u(){k.date=new Date,k.updateHover()}function h(e){return k.startDate=new Date(e.getFullYear(),e.getMonth(),1).getTime(),k.endDate=new Date(e.getFullYear(),e.getMonth()+1,0).getTime(),k.range=k.endDate-k.startDate,k.updateScale(k.range,k.width),k}function p(){$(".st-play-progress").css({width:(k.date.getTime()-k.startDate)/k.scale})}function C(e,t){k.scale=k.range/k.width}var k={};return k.onDateChangeCallback=null,k.clicked=!1,k.coordinateSystem="geocentric",k.date=null,k.onSystemCoordinateChangeCallback=null,k.play=!0,k.speed=1e3,k.width=null,k.init=e,k.dateClicked=t,k.forward=a,k.hidePrehover=n,k.onDateChange=o,k.onDateClicked=l,k.onDateClickedAndMove=c,k.rewind=d,k.showPrehover=i,k.toggleCoordinateSystem=r,k.togglePlay=s,k.toggleSpeed=g,k.toNow=u,k.updateDateRange=h,k.updateHover=p,k.updateScale=C,k}();
